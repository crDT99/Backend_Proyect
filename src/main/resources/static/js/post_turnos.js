window.addEventListener('load', function () {
    ...
    formulario.addEventListener('submit', function (event) {
       ...
       //creamos un JSON que tendrá los datos de la nueva turno
        const formData = {
            ...
            odontologo: {
                matricula: document.querySelector('#matricula').value.toUpperCase()
            }
        };
        //invocamos utilizando la función fetch la API turnos con el método POST que guardará
        //la turno que enviaremos en formato JSON
        const url = '/turnos';
        const settings = {
            method: 'POST',
            headers: {
        ...
        fetch(url, settings)
            ...
            .then(data => {
                 ...
                 let successAlert = '<div class="alert alert-success alert-dismissible">' +
                     ...
                     '<strong></strong> Turnos agregado </div>'
